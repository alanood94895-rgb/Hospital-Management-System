...
public class Constants {
        ...
        public static String PATIENT_ASSIGNED_SUCCESSFULLY = "Patient assigned successfully.";
        ...
        public static String PATIENT_ALREADY_SUCCESSFULLY = "Patient already assigned.";
